...
export function BookingDeleteButton({ bookingId }: { bookingId: number }) {
  ...
  async function handleDelete() {
    setPending(true);
    try { await deleteBooking(bookingId); } catch { /* action handles error */ }
    setPending(false);
    setOpen(false);
  }
      ...
      <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>This will permanently remove this booking and cannot be undone.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
